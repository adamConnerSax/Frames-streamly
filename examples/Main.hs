...
main = do
  ...
  forestFires :: Frames.Frame ForestFires <- FStreamly.inCoreAoS $ FStreamly.readTableOpt @_ @FStreamly.DefaultStream forestFiresParser forestFiresPath
  forestFiresColSubset :: Frames.Frame FFColSubset <- FStreamly.inCoreAoS $ readTableOpt fFColSubsetParser forestFiresPath
...
--  FStreamly.writeLines "exampleOutCS.csv" csvTextStreamCS
  ...
  forestFiresMissing :: Frames.Frame FFColSubset <- FStreamly.inCoreAoS $ readTableOpt fFColSubsetParser forestFiresMissingPath
  ...
  forestFiresMissing2 :: Frames.Frame FFInferOrMissing <- FStreamly.inCoreAoS $ readTableOpt fFInferOrMissingParser forestFiresMissingPath
  putStrLn $ "Loaded the same table but with the types for 'day' and 'wind' set to OrMissing. Has "
    ...
    <> " rows."
  forestFiresTypedDay :: Frames.Frame FFInferTypedDay <- FStreamly.inCoreAoS $ readTableOpt fFInferTypedDayParser forestFiresMissingPath
  putStrLn $ "Loaded complete table with a DayOfWeek type added. Has "
    <> show (tableLength forestFiresTypedDay)
    <> " rows."
  forestFiresTypedDayOM :: Frames.Frame FFInferTypedDayOrMissing <- FStreamly.inCoreAoS $ readTableOpt fFInferTypedDayOrMissingParser forestFiresMissingPath
